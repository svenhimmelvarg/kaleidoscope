...
from op.workflow import (
    workflow_get,
    workflow_get_prompt,
    workflow_invoke,
    workflow_invoke_prompt,
    workflow_lineage,
)
...
cli.add_command(workflow_get_prompt)
cli.add_command(workflow_invoke_prompt)
cli.add_command(workflow_lineage)
